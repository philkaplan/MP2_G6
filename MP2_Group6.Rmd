...
# Results
Through analysis of our predictions, we can see that at a flexion angle of about 75 degrees is where all three of our participants were predicted to move the max amount of weight. COnversely, we can see at double that angle, 150 degrees, which is full extension we see the smallest amount of weight predicted to move. This pattern is also followed when considering muscle torque at certain angles. Overall, looking at our plot above we can see a curve where an angle of 75 degrees is the prime angle to move the maximum amount of weight.
